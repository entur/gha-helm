...
|          <a name="input_container_name"></a>[container_name](#input_container_name)          | string |  false   |                            |                                           Replace the image of a <br>named container in the common.containers <br>array. Resolves the array index <br>automatically using the container name <br>in values.yaml. Can be combined <br>with an explicit image_set_path for <br>multi-app deploys.                                             |
